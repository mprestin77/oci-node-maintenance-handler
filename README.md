...
```text
image: <region-code>.ocir.io/<tenancy-namespace>/wd/watchdog:1.0
```
...
*Note: If you are using OCI Cloud Shell for deployment you can connect it to your VCN subnet using [Cloud Shell Private Networking](https://docs.oracle.com/en-us/iaas/Content/API/Concepts/cloudshellintro_topic-Cloud_Shell_Networking.htm#Cloud_Shell_Private_Access).*
