...
```
*Note: Kubernetes namespace must match the name of the namespace you created in [the previous step](https://github.com/mprestin77/oci-node-maintenance-handler?tab=readme-ov-file#create-namespace).*
